...
let vpcStack = new MediawikiVpcStack(app, 'vpc', {
    stackName: process.env.stack_name + '-vpc',
    env: defaultEnv

})

let ecsStack = new MediawikiEcsStack(app, 'ecs', {
    stackName: process.env.stack_name + '-ecs',
